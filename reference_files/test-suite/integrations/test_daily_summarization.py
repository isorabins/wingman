...
async def test_summarizer_initialization():
    ...
    from src.model_selector import detect_environment, Environment
    
    # Test default initialization - model depends on environment
    summarizer = ContentSummarizer()
    
    # In testing environment, should use Haiku for cost optimization
    # In production, should use Sonnet for quality
