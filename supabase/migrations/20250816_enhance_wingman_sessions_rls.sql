...
-- Dependencies: wingman_sessions table exists (created in wingman_tables migration)
...
-- Verify RLS is enabled (should already be enabled from initial wingman_sessions creation)
